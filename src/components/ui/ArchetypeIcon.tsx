...
/**
 * ArchetypeIcon — brand SVG icon per archetype ID.
 * Mirrors the approved icon set used in the landing page.
 */
...
export default function ArchetypeIcon({ id, className = "w-6 h-6" }: ArchetypeIconProps) {
  return (
    <svg
      className={className}
      fill="none"
